...
/*KO-2051*/ import static com.kms.katalon.core.checkpoint.CheckpointFactory.findCheckpoint
...
WebUI.verifyElementVisible(findTestObject('Page_Account Home/Quick Action/a_View My Licenses'))
...
def setup() {
    ...
    WebUI.callTestCase(findTestCase('Common Test Cases/Login'), [('username') : 'truongbaothuy93+73@gmail.com', ('password') : 'KzXoJXJYxul3D9DRe4bCdA=='], 
