...
String licenseName = WebUI.getText(findTestObject('Page_KatOne/Home/div_TC Free Trial text'))

System.out.println(licenseName)

WebUI.verifyEqual(licenseName.contains('TestCloud Free Trial\n5 parallel sessions'), true)

String url = WebUI.getUrl()

String orgId = url.substring(url.length() - 6)

WebUI.callTestCase(findTestCase('Common Test Cases/Delete Org'), [('orgId') : orgId, ('orgName') : orgName], FailureHandling.STOP_ON_FAILURE)
